...
export const LoginPageComponent = ({ setPage }: MyComponentsType) => {
            ...
            <div className="h-[93vh] flex justify-center items-center bg-[#ECEFF1]">
                <div className="w-full max-w-[400px] bg-white px-6 py-6 rounded shadow-lg">
                    ...
                    <div>
                        ...
                        <div className="text-center mt-1 text-sm text-gray-500 cursor-pointer">
                            <span onClick={() => setPage('forgot-password')}>Forgot Password?</span>
                        </div>
                    </div>
                </div>
            </div>
